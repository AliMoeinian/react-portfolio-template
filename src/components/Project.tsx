    ...
    <div className="projects-container section" id="projects">
      ...
      <div className="projects-grid">
        ...
        <div className="project">
          ...
          <p>
            Built official charts for COVID/vaccination tracking for an educational
            institution using JavaScript and the Google Sheets API v4. The
            dashboard served the university's leadership in their decision-making
            processes.
          </p>
        </div>
      </div>
